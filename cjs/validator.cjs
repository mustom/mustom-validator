...
const comparison = require('./method/comparison.cjs')
const condition = require('./method/condition.cjs')
const dataType = require('./method/data-type.cjs')
const regex = require('./method/regex.cjs')
const dataTransformation = require('./method/data-transformation.cjs')
const misc = require('./method/misc.cjs')
